...
export const setIsUserEditDialogOpen = (value) =>
  useUserStore.setState({ isEditUserDialogOpen: value });
...
export const setApplyLTVFilter = (value) =>
  useUserStore.setState({ applyLTVFilter: value });
...
export const setIsAssignRolesDialogOpen = (value) =>
  useUserStore.setState({ isAssignRolesDialogOpen: value });
