...
const RewardPoints = ({ id, userPoints, userRank }) => {
  const { activeCustomerMembershipId } = useUserStore();
  ...
  return (
    <div className="flex flex-col justify-start items-start w-full h-full space-y-4">
      ...
      <Can permissions={["app_api.view_occustomermembership"]}>
      ...
      <Card className="w-full px-4 py-4 space-y-4">
        <HeaderText
          ...
          text={t("Reward Points base on orders")}
        />
        ...
        {activeCustomerMembershipId && (
          <Card className="flex flex-col justify-start items-start w-full h-full px-4 py-4 space-y-4">
            <CardHeader className="py-2 ">
              <CardTitle>{t("Add Rewards Points")}</CardTitle>
              <CardDescription>
                {t("Make Add Rewards Points here. Click save when you are done.")}
              </CardDescription>
            </CardHeader>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="w-full px-1 pt-0">
                        <FormLabel className="capitalize">{t("Points")}</FormLabel>
                        <FormControl>
                          <Input
                            type="number"
                            placeholder={t("User Points")}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="w-full px-1 pt-2 relative">
                        <FormLabel className="capitalize">{t("Reason")}</FormLabel>
                        <FormControl>
                          <Textarea
                            type="text"
