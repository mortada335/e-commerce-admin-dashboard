import { MoreHorizontal, ShieldBan, ShieldCheck, SquarePen, Trash2, View } from "lucide-react";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
import { setIsChangeStatusDialogOpen, setIsGeneralCouponDialogOpen,
  setIsDeleteDialogOpen,
  setSelectedGeneralCoupon, } from "@/pages/general-coupons/store";
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem
            ...
            onClick={() => {
              ...
              toast({
                title: t("Copied"),
                description: `${item.id} ${t("copied to clipboard sucessfully.")}`,
              });
            }}
          >
            {t("Copy Id")}
          ...
          <Can permissions={["app_api.view_occouponhistory"]}>
            <DropdownMenuItem>
              <Link
                ...
                to={`/ecommerce/promo-codes/details/${item.id}`}
              >
                {" "}
