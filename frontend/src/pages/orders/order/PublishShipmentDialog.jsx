...
import { DELIVERY_SERVICE_PUBLISH_SHIPMENT, ORDERS_URL } from "@/utils/constants/urls";
        ...
        <DialogContent className="max-w-[90%]  sm:max-w-[500px] md:max-w-[700px]">
          <ScrollArea className=" h-[500px] pr-4 w-full ">
            <DialogHeader className="rtl:items-end">
              <DialogTitle className="tracking-wide">{t("Publish Shipment")}</DialogTitle>
              <DialogDescription>
                {t("Publish shipment order here. Click save when you are done.")}
              </DialogDescription>
            </DialogHeader>
            ...
            <Form {...form} className="h-full bg-black">
              ...
              >
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="w-full px-1 pt-0">
                      <FormLabel className="capitalize">{t("Sender Phone Number")}<span className="text-red-500 text-xl">*</span></FormLabel>
                      <FormControl>
                        <Input
                          type="text"
                          placeholder={t("Enter Sender Phone Number")}
                          value={field.value}
                          onChange={(e) => {
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="w-full px-1 pt-0">
                      <FormLabel className="capitalize">{t("Receiver Name")}<span className="text-red-500 text-xl">*</span></FormLabel>
                      <FormControl>
                        <Input
                          type="text"
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="w-full px-1 pt-0">
                      <FormLabel className="capitalize">{t("Receiver Phone Number")} <span className="text-red-500 text-xl">*</span></FormLabel>
                      <FormControl>
                        <Input
                          type="text"
                          // readOnly={order?.customer_data?.customer_number}
                          placeholder={t("Enter Receiver Phone Number")}
                          value={field.value}
                          onChange={(e) => {
                            field.onChange(e.target.value);
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="w-full px-1 pt-0">
                      <FormLabel className="capitalize">{t("Receiver Second Phone Number")}<span className="text-red-500 text-xl">*</span></FormLabel>
                      <FormControl>
                        <Input
                          type="text"
                          placeholder={t("Enter Receiver Second  Phone Number")}
                          value={field.value}
                          onChange={(e) => {
                            field.onChange(e.target.value);
                ...
                <div className="flex w-full justify-center items-center gap-2 ">
                  ...
                  <Label className="capitalize">{t("Receiver City")}<span className="text-red-500 text-xl">*</span></Label>
                  ...
                  <div className="flex flex-col gap-2 justify-start items-start w-full">
                  <Label className="capitalize">{t("Receiver Area")}<span className="text-red-500 text-xl">*</span></Label>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="w-full px-1 pt-0">
                      <FormLabel className="capitalize">{t("Location Details")}<span className="text-red-500 text-xl">*</span></FormLabel>
                      <FormControl>
                        <Textarea
                         
                          placeholder={t("Enter Location Details")}
                          value={field.value}
                          onChange={(e) => {
                            field.onChange(e.target.value);
