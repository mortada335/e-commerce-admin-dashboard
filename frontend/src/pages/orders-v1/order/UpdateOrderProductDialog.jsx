...
import { ORDERS_V1_URL, PRODUCTS_URL } from "@/utils/constants/urls";
...
export default function UpdateOrderProductDialog() {
  ...
  const onSave = async () => {
    ...
    try {
      ...
      setIsAction(false)
      queryClient.invalidateQueries({ queryKey: ['OrderV1Details'] })
        ...
        <DialogContent className="max-w-[350px] sm:max-w-[500px] md:max-w-[700px]">
          <ScrollArea className=" h-[500px] pr-4 w-full ">
            <DialogHeader className="pb-4">
              <DialogTitle>Update Products Order</DialogTitle>
              <DialogDescription>
                Make changes to Products Order here. Click save when you are
                done.
              </DialogDescription>
            </DialogHeader>
            ...
            <Table >
              ...
              <TableBody>
                {productsOrder?.length > 0 ? (
                  ...
                  <Text
                    className="py-4 px-4"
                    text="There is no products added to this order"
                  />
                )}
              </TableBody>
            </Table>
