...
import { sectionSchema } from "@/utils/validation/section";
...
export function SectionDialog({ isDialogOpen, setIsDialogOpen, section }) {
  ...
  useEffect(() => {
    if (section && section !== null && section !== undefined && isDialogOpen) {
      ...
      form.setValue("order_id", section.order_id);
  ...
  const onClose = () => {
    ...
    // Reset isDeleteBackground state to false.
    setIsDeleteBackground(false);
  };
  ...
  const onSubmit = async () => {
    ...
    isDeleteBackground && formData.append("section_background", "");
    ...
    formData.append("order_id", formFields.order_id);
      ...
      <ScrollArea className=" w-[99%] md:w-full border-none">
        <ScrollArea className=" h-[500px] sm:h-[600px] pr-4 w-full ">
          <DialogHeader className={"rtl:items-end"}>
            <DialogTitle>{section?.id ? t("Edit") : t("Create")} {t("Section")}</DialogTitle>
            <DialogDescription>
              {section?.id ? t("Make changes to your") : t("Create")} {t("section here")}.
              ...
              >
                    ...
                    render={({ field }) => (
                      <FormItem className="w-full px-1 pt-0">
                        ...
                        <FormControl>
                          <Input
                            type="text"
                            placeholder={t("Section title in english")}
                            value={field.value}
                            onChange={(e) => {
                    ...
                    render={({ field }) => (
                      <FormItem className="w-full px-1">
                        ...
                        <FormControl>
                          <Input
                            type="text"
                            placeholder={t("Section title in arabic")}
                            value={field.value}
                            onChange={(e) => {
                              field.onChange(e.target.value);
                ...
                <div className="flex justify-between items-center space-x-4 w-full">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="w-full px-1 py-0">
                        <FormLabel>{t("Sub title in english")}</FormLabel>
                        <FormControl>
                          <Input
                            type="text"
                            placeholder={t("Section sub title in english")}
                            value={field.value}
                            onChange={(e) => {
                              field.onChange(e.target.value);
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="w-full px-1">
                        <FormLabel>{t("Sub title in arabic")}</FormLabel>
                        <FormControl>
                          <Input
                            type="text"
                            placeholder={t("Section sub title in arabic")}
                            value={field.value}
                            onChange={(e) => {
                              field.onChange(e.target.value);
                      ...
                      <FormItem className="w-full px-1">
                        ...
                        <FormControl>
                          <Input
                            ...
                            type="number"
                            placeholder={t(
                              "this refer to the section order in home page, 5 means the 5th section"
                            )}
                            value={field.value}
                            onChange={(e) => {
                              field.onChange(e.target.value);
                      ...
                      <FormItem className="w-full px-1">
                        ...
                        <FormControl>
                          <Input
                            ...
                            type="number"
                            placeholder={t(
                              "Add number of products in the section"
                            )}
                            value={formFields.section_products_limit || ""}
                            onChange={(e) => {
                              field.onChange(e.target.value);
                              setFormFields({
                                ...formFields,
                      ...
                      <FormItem className="w-full px-1">
                        ...
                        /> */}
                          ...
                          <FileInput
                            ...
                            onDeleteSectionBackground={setIsDeleteBackground}
                          />
                        </FormControl>
